...
const Disclaimer = () => (
  <Shell>
    ...
    <article className="mx-auto max-w-3xl px-6 py-16 prose prose-sm dark:prose-invert">
      ...
      <h2>No reliance</h2>
      <p>
        You should not act, or refrain from acting, on the basis of any content from UK Net
        Pay without first taking advice from a qualified accountant, tax adviser, or
      ...
      <h2>Liability</h2>
      <p>
        To the fullest extent permitted by law, UK Net Pay accepts no liability for any loss
        arising from reliance on the calculators, articles, or any other material presented
        on this site.
      </p>
    </article>
  </Shell>
