...
const Terms = () => (
  <Shell>
    ...
    <article className="mx-auto max-w-3xl px-6 py-16 prose prose-sm dark:prose-invert">
      <h1>Terms of Use</h1>
      <p>
        By using UK Net Pay you agree to these terms. The calculators and
        articles are provided "as is" for general information only and do not
        constitute legal, tax, accounting, or financial advice.
      </p>
      ...
      <p>All site content, design and calculation engine © UK Net Pay {new Date().getFullYear()}.</p>
      <h2>Governing law</h2>
